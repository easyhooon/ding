...
internal class DingInitializer : Initializer<Unit> {
...
private object LauncherShortcutController {
    ...
    fun register(context: Context) {
        ...
        val shortcut = ShortcutInfo.Builder(context, SHORTCUT_ID)
            .setShortLabel(context.getString(R.string.ding_shortcut_label))
            .setLongLabel(context.getString(R.string.ding_shortcut_long_label))
            .setIcon(Icon.createWithResource(context, R.drawable.ic_ding))
